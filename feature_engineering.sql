...
, CASE 
  ...
  THEN
      SUM("confidence") OVER (PARTITION BY "user_id", "fno", "fvalue" RANGE  INTERVAL '1' HOUR PRECEDING) - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "user_id", "fno","fvalue" RANGE INTERVAL '1' HOUR PRECEDING) - 1
  END as "num_usr_win_1h"
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      100 * (COUNT(*) OVER (PARTITION BY "fno" RANGE INTERVAL '1' HOUR PRECEDING) - 1)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "fno" RANGE INTERVAL '1' HOUR PRECEDING ) - 1
  END as "denom_usr_win_1h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "user_id", "fno" RANGE INTERVAL '1' HOUR PRECEDING)
  AS "usr_vel_1h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "device_id", "fno", "fvalue" RANGE INTERVAL '1' HOUR PRECEDING)  - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "device_id", "fno","fvalue" RANGE INTERVAL '1' HOUR PRECEDING) - 1
  END as "num_dev_win_1h"
, "denom_usr_win_1h" AS "denom_dev_win_1h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "device_id", "fno" RANGE INTERVAL '1' HOUR PRECEDING)
  AS "dev_vel_1h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "user_id", "fno", "fvalue" RANGE INTERVAL '6' HOUR PRECEDING) - COALESCE("confidence",0.0) 
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "user_id", "fno","fvalue" RANGE INTERVAL '6' HOUR PRECEDING) - 1
  END as "num_usr_win_6h"
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      100 * (COUNT(*) OVER (PARTITION BY "fno" RANGE INTERVAL '6' HOUR PRECEDING) - 1) 
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "fno" RANGE INTERVAL '6' HOUR PRECEDING) - 1
  END as "denom_usr_win_6h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "user_id", "fno" RANGE INTERVAL '6' HOUR PRECEDING)
  AS "usr_vel_6h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "device_id", "fno", "fvalue" RANGE INTERVAL '6' HOUR PRECEDING) - COALESCE("confidence",0.0)  
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "device_id", "fno","fvalue" RANGE INTERVAL '6' HOUR PRECEDING) - 1
  END as "num_dev_win_6h"
, "denom_usr_win_6h" AS "denom_dev_win_6h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "device_id", "fno" RANGE INTERVAL '6' HOUR PRECEDING)
  AS "dev_vel_6h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "user_id", "fno", "fvalue" RANGE INTERVAL '24' HOUR PRECEDING) - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "user_id", "fno","fvalue" RANGE INTERVAL '24' HOUR PRECEDING) - 1
  END as "num_usr_win_24h"
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      100 * (COUNT(*) OVER (PARTITION BY "fno" RANGE INTERVAL '24' HOUR PRECEDING) - 1)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "fno" RANGE INTERVAL '24' HOUR PRECEDING) - 1
  END as "denom_usr_win_24h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "user_id", "fno" RANGE INTERVAL '24' HOUR PRECEDING)
  AS "usr_vel_24h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "device_id", "fno", "fvalue" RANGE INTERVAL '24' HOUR PRECEDING) - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "device_id", "fno","fvalue" RANGE INTERVAL '24' HOUR PRECEDING) - 1 
  END as "num_dev_win_24h"
, "denom_usr_win_24h" AS "denom_dev_win_24h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "device_id", "fno" RANGE INTERVAL '24' HOUR PRECEDING)
  AS "dev_vel_24h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "user_id", "fno", "fvalue" RANGE INTERVAL '7' DAY PRECEDING) - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "user_id", "fno","fvalue" RANGE INTERVAL '7' DAY PRECEDING) - 1 
  END as "num_usr_win_168h"
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      100 * (COUNT(*) OVER (PARTITION BY "fno" RANGE INTERVAL '7' DAY PRECEDING) - 1)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "fno" RANGE INTERVAL '7' DAY PRECEDING) - 1
  END as "denom_usr_win_168h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "user_id", "fno" RANGE INTERVAL '7' DAY PRECEDING)
  AS "usr_vel_168h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "device_id", "fno", "fvalue" RANGE INTERVAL '7' DAY PRECEDING)  - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "device_id", "fno","fvalue" RANGE INTERVAL '7' DAY PRECEDING) - 1
  END as "num_dev_win_168h"
, "denom_usr_win_168h" AS "denom_dev_win_168h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "device_id", "fno" RANGE INTERVAL '7' DAY PRECEDING)
  AS "dev_vel_168h"
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "user_id", "fno", "fvalue" RANGE INTERVAL '30' DAY PRECEDING)  - COALESCE("confidence",0.0)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "user_id", "fno","fvalue" RANGE INTERVAL '30' DAY PRECEDING) - 1 
  END as "num_usr_win_720h"
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      100 * (COUNT(*) OVER (PARTITION BY "fno" RANGE INTERVAL '30' DAY PRECEDING) - 1)
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "fno" RANGE INTERVAL '30' DAY PRECEDING) - 1
  END as "denom_usr_win_720h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "user_id", "fno" RANGE INTERVAL '30' DAY PRECEDING)
  AS "usr_vel_720h"
FROM "interface"."fe_pipeline_step_435";

CREATE OR REPLACE PUMP "interface"."fe_pipeline_step_440_pump" STOPPED
AS
INSERT INTO "interface"."fe_pipeline_step_440"
SELECT STREAM *
...
, CASE 
  WHEN "confidence" IS NOT NULL    -- one of the location features
  THEN
      SUM("confidence") OVER (PARTITION BY "device_id", "fno", "fvalue" RANGE INTERVAL '30' DAY PRECEDING) - COALESCE("confidence",0.0) 
  ELSE                             -- 'normal' feature
      COUNT("fvalue") OVER (PARTITION BY "device_id", "fno","fvalue" RANGE INTERVAL '30' DAY PRECEDING) - 1
  END as "num_dev_win_720h"
, "denom_usr_win_720h" AS "denom_dev_win_720h"
, COUNT(DISTINCT "fvalue") OVER (PARTITION BY "device_id", "fno" RANGE INTERVAL '30' DAY PRECEDING)
  AS "dev_vel_720h"
