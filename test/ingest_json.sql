...
"PARSER" 'JSON',
        ...
        "f57_visitId_PATH" '$.f57_visitId',
        "rulesetExternalId_PATH" '$.rulesetExternalId',
        "rulename_PATH" '$.rulename',
        "ruleExpectedValue_PATH" '$.ruleExpectedValue',
        ...
        "f14_gemaltoRiskEngine_attributes_deviceBrowser_osVersionOfFamily_PATH" '$.f14_gemaltoRiskEngine_attributes_deviceBrowser_osVersionOfFamily',
        "f13_gemaltoRiskEngine_attributes_deviceBrowser_osReleaseDateOrder_PATH" '$.f13_gemaltoRiskEngine_attributes_deviceBrowser_osReleaseDateOrder',
        "f09_gemaltoRiskEngine_attributes_deviceBrowser_isRooted_PATH" '$.f09_gemaltoRiskEngine_attributes_deviceBrowser_isRooted',
        "ip_address_PATH" '$.ip_address',
        "f55_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_ip_type_PATH" '$.f55_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_ip_type',
        "f51_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_organization_PATH" '$.f51_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_organization',
        "f46_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_carrier_PATH" '$.f46_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_carrier',
        "f45_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_asn_PATH" '$.f45_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_asn',
        "f47_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_connection_type_PATH" '$.f47_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_connection_type',
        "f50_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_line_speed_PATH" '$.f50_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_line_speed',
        "f49_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_ip_routing_type_PATH" '$.f49_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_ip_routing_type',
        "f48_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_hosting_facility_PATH" '$.f48_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_hosting_facility',
        "f44_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_Domain_tld_PATH" '$.f44_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_Domain_tld',
        "f43_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_Domain_sld_PATH" '$.f43_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Network_Domain_sld',
        "f37_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_continent_PATH" '$.f37_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_continent',
        "f39_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_latitude_PATH" '$.f39_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_latitude',
        "f40_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_longitude_PATH" '$.f40_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_longitude',
        "f34_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CountryData_country_PATH" '$.f34_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CountryData_country',
        "f33_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CountryData_country_code_PATH" '$.f33_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CountryData_country_code',
        "country_cf_PATH" '$.country_cf',
        "f42_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_region_PATH" '$.f42_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_region',
        "f36_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_StateData_state_PATH" '$.f36_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_StateData_state',
        "f35_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_StateData_state_code_PATH" '$.f35_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_StateData_state_code',
        "state_cf_PATH" '$.state_cf',
        "f38_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_dma_PATH" '$.f38_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_dma',
        "f41_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_msa_PATH" '$.f41_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_msa',
        "f30_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CityData_city_PATH" '$.f30_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CityData_city',
        "f31_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CityData_postal_code_PATH" '$.f31_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CityData_postal_code',
        "f32_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CityData_time_zone_PATH" '$.f32_gemaltoRiskEngine_attributes_ipintelligence_ipinfo_Location_CityData_time_zone',
        "city_cf_PATH" '$.city_cf',
        "name_PATH" '$.name',
        "f27_gemaltoRiskEngine_attributes_deviceMobileApp_platformSettings_signals_isWifiEnabled_PATH" '$.f27_gemaltoRiskEngine_attributes_deviceMobileApp_platformSettings_signals_isWifiEnabled',
        "f26_gemaltoRiskEngine_attributes_deviceMobileApp_platformSettings_signals_isLocationEnabled_PATH" '$.f26_gemaltoRiskEngine_attributes_deviceMobileApp_platformSettings_signals_isLocationEnabled',
        "f28_gemaltoRiskEngine_attributes_deviceMobileApp_platform_signals_family_PATH" '$.f28_gemaltoRiskEngine_attributes_deviceMobileApp_platform_signals_family',
        "version_PATH" '$.version',
        "isRooted0_PATH" '$.isRooted0',
        "f24_gemaltoRiskEngine_attributes_deviceMobileApp_network_signals_type_PATH" '$.f24_gemaltoRiskEngine_attributes_deviceMobileApp_network_signals_type',
        "f23_gemaltoRiskEngine_attributes_deviceMobileApp_network_signals_hwAddress_PATH" '$.f23_gemaltoRiskEngine_attributes_deviceMobileApp_network_signals_hwAddress',
        "f19_gemaltoRiskEngine_attributes_deviceMobileApp_device_signals_fingerprint_PATH" '$.f19_gemaltoRiskEngine_attributes_deviceMobileApp_device_signals_fingerprint',
        ...
        "additionalNotes_PATH" '$.additionalNotes',
        "access_PATH" '$.access',
        "f25_gemaltoRiskEngine_attributes_deviceMobileApp_platformSettings_signals_isBluetoothEnabled_PATH" '$.f25_gemaltoRiskEngine_attributes_deviceMobileApp_platformSettings_signals_isBluetoothEnabled',
        "time0_PATH" '$.time0',
        "f22_gemaltoRiskEngine_attributes_deviceMobileApp_location_signals_source_PATH" '$.f22_gemaltoRiskEngine_attributes_deviceMobileApp_location_signals_source',
        "latitude0_PATH" '$.latitude0',
        "longitude0_PATH" '$.longitude0',
        "accuracy_PATH" '$.accuracy',
        "altitude_PATH" '$.altitude',
        "f04_context_flag002_PATH" '$.f04_context_flag002',
        "f03_context_flag001_PATH" '$.f03_context_flag001',
